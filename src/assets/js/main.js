...
document.addEventListener("DOMContentLoaded", () => {
    ...
    logoMask.setAttribute(
        "transform",
        `translate(${logoHorizontalPosition}, ${logoVerticalPosition}) scale(${logoScaleFactor * 1.25})`
    );
    ...
    ScrollTrigger.create({
        ...
        onUpdate: (self) => {
            ...
            const fadeOpecity = 1 - scrollProgress * (1 / 0.15);
            ...
            if (scrollProgress <= 0.85) {
                ...
                gsap.set(heroImgContainer, {
                    scale: heroImgContainerScale * 0.8,
                });
            ...
            if (scrollProgress >= 0.6 && scrollProgress <= 0.85) {
                ...
                overlayCopy.style.background = `linear-gradient(
                    to bottom, #111117 0%,  #111117 ${gradientTopPosition}%, 
                  #e66461 ${gradientBottomPosition}%,#e66461 100%)`;
